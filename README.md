...
* To setup the h2 database run.
        ...
        java -jar build/libs/dropwizard-example-1.0.0-SNAPSHOT.jar db migrate example.yml

* To run the server run.

        java -jar build/libs/dropwizard-example-1.0.0-SNAPSHOT.jar server example.yml
